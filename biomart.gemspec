...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "README.rdoc", "Rakefile", "lib/biomart.rb", "lib/biomart/attribute.rb", "lib/biomart/database.rb", "lib/biomart/dataset.rb", "lib/biomart/filter.rb", "lib/biomart/server.rb", "script/console", "script/destroy", "script/generate", "test/test_biomart.rb", "test/test_helper.rb"]
